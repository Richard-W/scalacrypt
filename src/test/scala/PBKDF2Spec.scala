...
class PBKDF2Spec extends FlatSpec with Matchers {
  ...
  "PBKDF2" should "be consistent with the test vectors." in {
    ...
    val res12 = PBKDF2HmacSHA1(p1.getBytes, s1.getBytes, i1, l1)
    ...
    val res22 = PBKDF2HmacSHA1(p2.getBytes, s2.getBytes, i2, l2)
    ...
    val res32 = PBKDF2HmacSHA1(p3.getBytes, s3.getBytes, i3, l3)
    res31 should be (res32)
    
    val p4 = "passwordPASSWORDpassword"
    ...
    val res42 = PBKDF2HmacSHA1(p4.getBytes, s4.getBytes, i4, l4)
